...
export declare const CANONICAL_BUILDING_TYPE_IDS: readonly ["metal_extractor", "plasma_refinery", "warehouse", "energy_generator", "control_center", "shipyard", "research_lab", "hangar", "defense_turret", "trading_center", "radar", "residential_area"];
