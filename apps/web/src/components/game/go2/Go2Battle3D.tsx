...
// ---------------------------------------------------------------------------
// HELPER: Default frame factory for when no battle data is provided
// ---------------------------------------------------------------------------

function createDefaultFrame(): BattleFrame {
  return {
    round: 0,
    phase: 'move',
    attackerShips: [],
...
// ---------------------------------------------------------------------------
// DEMO: Generate sample battle frames for testing
// ---------------------------------------------------------------------------

export function generateDemoBattleFrames(): BattleFrame[] {
  const frames: BattleFrame[] = [];

  // Initial state: 3 attackers vs 3 defenders
  ...
  // Apply damage
  defenders[0].shield = 75;
  defenders[0].structure = 95;
  attackers[0].shield = 80;
  attackers[0].structure = 97;
  ...
  // Round 2: Attack - heavy engagement
  attackers[0].shield = 50;
  attackers[0].structure = 70;
  defenders[0].shield = 30;
  defenders[0].structure = 60;
  defenders[1].shield = 60;
  defenders[1].structure = 85;
  ...
  frames.push({
    ...
    phase: 'move',
    attackerShips: attackers.map((s) => ({ ...s })),
    defenderShips: defenders.map((s) => ({ ...s, cell: s.id === 'd1' ? s.cell : s.cell })),
    actions: [
  ...
  defenders[0].structure = 0;
  defenders[0].shield = 0;
  ...
  defenders[1].shield = 30;
  defenders[1].structure = 55;
  attackers[0].shield = 20;
  attackers[0].structure = 45;
  ...
  defenders[1].shield = 0;
  defenders[1].structure = 5;
  attackers[1].shield = 40;
  attackers[1].structure = 60;
  ...
  defenders[1].structure = 0;
  defenders[1].shield = 0;
  attackers[2].shield = 80;
  attackers[2].structure = 92;
