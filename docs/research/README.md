...
- `game-systems.md` - Sistemas de juego documentados
- `data-model.md` - Esquema de entidades de datos
- `combat-model.md` - Diseño del sistema de combate
- `mvp.md` - Definición del Producto Mínimo Viable
- `rebuild-plan.md` - Stack técnico moderno y fases
- `legal-safety.md` - Guía para evitar problemas legales
